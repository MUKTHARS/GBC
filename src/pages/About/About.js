...
const About = () => {
  ...
  const milestones = [
    { year: '2010', title: 'Company Founded', description: 'Started as local construction service provider' },
    { year: '2013', title: 'Government Projects', description: 'Awarded first major government road contract' },
    { year: '2016', title: 'Expansion', description: 'Expanded services to material supply and equipment rental' },
    { year: '2020', title: 'Regional Leader', description: 'Became leading contractor in Nilgiris region' },
    { year: '2024', title: 'Current Status', description: '250+ projects completed across multiple sectors' }
  ];

  const values = [
    { icon: '🎯', title: 'Quality Excellence', description: 'Uncompromising quality in every project we undertake' },
    { icon: '⏱️', title: 'Timely Delivery', description: 'Commitment to project timelines and deadlines' },
    { icon: '🤝', title: 'Client Partnership', description: 'Building long-term relationships with our clients' },
    { icon: '💡', title: 'Innovation', description: 'Adopting modern construction techniques and technologies' },
    { icon: '🛡️', title: 'Integrity', description: 'Transparent and ethical business practices' },
    { icon: '🌱', title: 'Sustainability', description: 'Environmentally conscious construction practices' }
  ];
            ...
            <div className="content-grid">
              <div className="content-main">
                ...
                <p className="lead-text">
                  Founded in 2010, Sathguru Balaji Traders has grown from a local construction service 
                  provider to one of the most trusted names in the construction industry across Tamil Nadu.
                </p>
                ...
                <div className="expertise-section">
                  ...
                  <div className="expertise-grid">
                    <div className="expertise-item">
                      <span className="expertise-badge">Highways Department</span>
                      <span className="expertise-badge">DRDA Projects</span>
                      <span className="expertise-badge">Municipality Works</span>
                      ...
                      <span className="expertise-badge">Building Construction</span>
              ...
              <div className="content-sidebar">
                <div className="company-profile-card">
                  <div className="profile-header">
                    <h3>Sathguru Balaji Traders</h3>
                    <p className="profile-tagline">MTP Road Contractor & Building Material Supplier</p>
                  </div>
            ...
            <div className="mission-content">
              <div className="mission-statement">
                ...
                <p className="mission-text">
                  To revolutionize the construction industry through innovative solutions, 
                  uncompromising quality, and client-centric approaches that build sustainable 
