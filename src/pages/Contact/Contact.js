        ...
        <div className="contact-hero-content">
          <div className="hero-text-content">
            ...
            <h1 className="hero-main-title">
              Let's <span className="highlight">Build</span> Together
            </h1>
            <p className="hero-description">
              Ready to start your construction project? Contact us for comprehensive 
              solutions, competitive pricing, and expert guidance every step of the way.
            </p>
            ...
            <div className="contact-info-card-enhanced">
              <div className="contact-header">
                ...
                <p className="contact-info-description">
                  Reach out to us for any construction requirements, vehicle hire, 
                  or building materials. We're here to help you build your dreams.
                </p>
              </div>
                ...
                <div className="business-details-enhanced">
                  <div className="business-detail-item-enhanced">
                    ...
                    <div className="detail-content">
                      ...
                      <span>{process.env.REACT_APP_COMPANY_NAME || 'Sathguru Balaji Traders'} MTP</span>
                    </div>
                  </div>
                  <div className="business-detail-item-enhanced">
                    <div className="detail-icon">🎯</div>
                    <div className="detail-content">
                      ...
                      <span>Fort Road Contractor & Building Material Supplier</span>
                    </div>
                  </div>
                  <div className="business-detail-item-enhanced">
                    <div className="detail-icon">🚀</div>
                    <div className="detail-content">
                      ...
                      <span>Your One-Stop Solution for All Construction Needs</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="image-container">
              ...
              <div className="image-overlay-enhanced">
                <div className="overlay-content">
                  ...
                  <p>Quality road work across Tamil Nadu with modern equipment</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="image-container">
              ...
              <div className="image-overlay-enhanced">
                <div className="overlay-content">
                  ...
                  <h4>Vehicle Fleet</h4>
                  <p>Well-maintained construction equipment for all your needs</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="image-container">
              ...
              <div className="image-overlay-enhanced">
                <div className="overlay-content">
                  ...
                  <p>Commercial & residential projects with quality assurance</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="quick-contact-enhanced">
        ...
        <div className="quick-contact-content-enhanced">
          <div className="cta-text">
            ...
            <p>Call us now for quick quotes, emergency services, and instant consultation</p>
          </div>
          <div className="quick-contact-actions">
            ...
            <a href="https://wa.me/919965555652" className="btn btn-large btn-secondary">
